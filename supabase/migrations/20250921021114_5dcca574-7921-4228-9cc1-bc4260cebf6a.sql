-- Create test data and booking function (fixed handle format)

-- First, create a test profile with valid handle
INSERT INTO public.profiles (id, user_id, full_name, handle, email, role)
VALUES (gen_random_uuid(), gen_random_uuid(), 'Coach Demo', 'coach_demo', 'coach@demo.com', 'coach');
...
SELECT 
  ...
  true,
  true
FROM public.profiles p WHERE p.handle = 'coach_demo';

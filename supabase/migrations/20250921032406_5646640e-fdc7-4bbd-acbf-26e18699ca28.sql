...
-- =========================
-- G) LIB SCREEN JSON (SIMPLE TABLE - WILL CREATE VIEW LATER)
-- =========================
...
-- Crear tabla temporal (será convertida en vista después)
create table if not exists public.lib_screen_json_temp (
